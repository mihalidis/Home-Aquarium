...
describe('Helper Functions', () => {
  describe('calculateTimeDifference', () => {
    it('should calculate the correct time difference in hours and days', () => {
      const date1 = moment('2023-10-01 12:00', 'YYYY-MM-DD HH:mm')
      const date2 = moment('2023-10-02 12:00', 'YYYY-MM-DD HH:mm')
    ...
    it('should return zero for the same date', () => {
      const date1 = moment('2023-10-01 12:00', 'YYYY-MM-DD HH:mm')
      const date2 = moment('2023-10-01 12:00', 'YYYY-MM-DD HH:mm')
      const result = calculateTimeDifference(date1, date2)
